...
echo -e  "Tools    : NEWBIE CYBER $GRUP      
" |lolcat
echo -e  "By  : MR.ANONIM $CYBER " |lolcat
echo -e  "SELAMAT DATANG : DI TOOLS NEWBIE CYBER
$NEWBIE " |lolcat
###################################################
# CTRL + C
###################################################
...
echo ""
echo -e "╭>SILAHKAN DI PILIH" |lolcat
read -p "╰─#" pil;
...
6) echo "created by : Mr.Anonim" | lolcat
exit
;;
